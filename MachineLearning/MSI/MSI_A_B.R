...
plot(predicted.lm, testNB$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
...
plot(predicted.knn,testNB$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g",col = "blue", 
...
plot(predicted.rf, testNB$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
...
plot(predicted.SVMP,testNB$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
...
plot(y_pred,testNB$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
...
plot(predicted.SVMLM.TVC,xlim= c(0,9), ylim=c(0,9),testNB$TVC,xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
...
##Linear Model plot predicted values vs Actual/Observed values
plot(predicted.lm.ps, testNb$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
...
# RandomForest plot predicted values vs Actual/Observed values
plot(predicted.rf.ps,testNb$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
...
plot(predicted.SVMP.PS,testNb$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
...
# SVM linear plot predicted values vs Actual/Observed values
plot(predicted.SVMLM.PS,testNb$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
...
plot(predicted.knn.ps, testNb$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
...
plot(y_pred.ps, testNb$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
