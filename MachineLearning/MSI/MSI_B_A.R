...
mean(lm.model.fit.TVC$resample$RMSE)
...
plot(predicted.lm, testNA$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
...
plot(predicted.knn,testNA$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g",col = "blue", 
...
plot(predicted.rf, testNA$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
...
plot(predicted.SVMP,testNA$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
...
regressor = svm(formula = TVC ~ .,
                data = trainNB,
                type = 'eps-regression',
                kernel = 'radial')##Training model
...
plot(y_pred,testNA$TVC,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
...
plot(predicted.SVMLM.TVC,xlim= c(0,9), ylim=c(0,9),testNA$TVC,xlab="Predcted log10 TVC/g",ylab="Actual log10 TVC/g", col="blue",
     main=paste("Linear SVM Model for TVC - RMSE:",round(RMSE.SVMLM.TVC,digits = 2),"Precentage :",round(percentage_SVMLM_TVC, digits = 2),"%"))
abline(a=0,b=1)
abline(a=-1,b=1)
abline(a=1,b=1)
######################################################################################################################################
...
##Linear Model plot predicted values vs Actual/Observed values
plot(predicted.lm.ps, testNa$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
...
# RandomForest plot predicted values vs Actual/Observed values
plot(predicted.rf.ps,testNa$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
...
plot(predicted.SVMP.PS,testNa$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
...
# SVM linear plot predicted values vs Actual/Observed values
plot(predicted.SVMLM.PS,testNa$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
     main=paste("linear SVM Model for Pseudomonas -  RMSE:",round(RMSE.SVMLM.ps,digits = 2),"Precentage :",round(percentage_SVMLM_Pseudomonas, digits = 2),"%"))
abline(a=0,b=1)
abline(a=-1,b=1)
abline(a=1,b=1)
####################################################################################
...
plot(predicted.knn.ps, testNa$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
...
regressor.ps = svm(formula = Pseudomonas.spp. ~ .,
                   data = trainNb,
                   type = 'eps-regression',
                   kernel = 'radial')##Training model
...
plot(y_pred.ps, testNa$Pseudomonas.spp.,xlim= c(0,9), ylim=c(0,9),xlab="Predcted log10 Pseudomonas/g",ylab="Actual log10 Pseudomonas/g", col="blue",
